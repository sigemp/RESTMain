 ...
 * @author cristian
 */
public class WABMGsyProv extends SgJInternalFrame implements PageableInterface {

    private GsyProvModel dm;
    ...
    public void init() {
        ...
        String[] cols = {ColumName.ID.getName(), ColumName.DESCRIPCION.getName()};
        dm = new GsyProvModel(cols);
    ...
    private void acciones(CRUD cur) {
        ...
        try {
            ...
            Logger.getLogger(WABMGsyProv.class.getName()).log(Level.SEVERE, null, ex);
            me(ex);
        }
    }
    ...
    class GsyProvModel extends ListTableModel<GsyProv> {
        ...
        public GsyProvModel(String[] columnNames, JTable jtablaAsociada) throws SgException {
