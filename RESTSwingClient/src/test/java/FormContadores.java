...
public class FormContadores extends javax.swing.JPanel {
     ...
     */
    public GsyContadores getCurrentRecord() {
...
//        contador.setTrFormatoImpresion((AbstractComprobante) jcb_FormatoImpresion.getSelectedItem());
//        contador.setTrFormatoVistaPrevia((AbstractComprobante) jcb_FormatoVistaPrevia.getSelectedItem());
//        contador.setTrSistema((Sistema) jcb_tiposContador.getSelectedItem());
//        contador.setTrCompEmisionComprobante((ComportamientoEmisionComprobante) jcb_ComportamientoEmisionComprobante.getSelectedItem());
    ...
    public void setCurrentRecord(GsyContadores currentRecord) {
        ...
        Sistema tipoContador = currentRecord.getTrSistema();
        ...
        AbstractComprobante formatoImpresionId = currentRecord.getTrFormatoImpresion();
        AbstractComprobante formatoVistaPreviaId = currentRecord.getTrFormatoVistaPrevia();
        ...
        ComportamientoEmisionComprobante coomp = currentRecord.getTrCompEmisionComprobante();
        ...
        List<Comprobante> listTiposComprobantes = controladorContadorTipo.getListByContadorId(currentRecord);

        model.removeAllElements();
        for (Comprobante tc : listTiposComprobantes) {
            model.addElement(tc);
        }
    ...
    private void guardarDatos() {
        ...
        try {
            ...
            GsyContadores tmpContador = getCurrentRecord();
